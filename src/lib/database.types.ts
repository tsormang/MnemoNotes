  ...
  public: {
    Tables: {
      ...
      note_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "note_categories_icon_id_fkey"
            columns: ["icon_id"]
            isOneToOne: false
            referencedRelation: "app_icons"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "note_categories_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      organization_registration_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "organization_registration_requests_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
