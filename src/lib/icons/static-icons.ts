...
export const STATIC_APP_ICONS: AppIcon[] = [
  ...
  { id: 'role-user-cog', label: 'Manager', path: '/icons/entities/role-user-cog.svg', entityTypes: ['company_role'], tags: ['manager'], sortOrder: 30 },
  { id: 'role-pill', label: 'Pharmacist', path: '/icons/entities/role-pill.svg', entityTypes: ['company_role'], tags: ['pharmacy'], sortOrder: 31 },
  { id: 'role-eye', label: 'Viewer', path: '/icons/entities/role-eye.svg', entityTypes: ['company_role'], tags: ['viewer'], sortOrder: 32 },
